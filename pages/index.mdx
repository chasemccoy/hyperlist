...
### An infotainment newsletter for the independent web ![](/static/stars.gif) <span>Sign up today!</span>
...
we're keepin' it casual. hyperlist is only delivered when there's enough stuff to share. expect ~2 issues a month. no spam, ever.
